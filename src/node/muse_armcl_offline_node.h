#ifndef MUSE_ARMCL_OFFLINE_NODE_H
#define MUSE_ARMCL_OFFLINE_NODE_H
...
public:
    ...
    using allocator_t = Eigen::aligned_allocator<MuseARMCLOfflineNode>;
    MuseARMCLOfflineNode();
    ~MuseARMCLOfflineNode();
...
#endif // MUSE_ARMCL_OFFLINE_NODE_H
